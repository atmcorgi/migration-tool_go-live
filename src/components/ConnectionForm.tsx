...
export function ConnectionForm({
  ...
  const getEnvironments = (type: "source" | "target"): string[] => {
    ...
    savedPresets.forEach((preset: any) => {
      const env =
        type === "source" ? preset.sourceEnvironment : preset.targetEnvironment;
  ...
  const loadPresetByEnvironment = (
    environment: string,
    type: "source" | "target"
  ) => {
    const preset = savedPresets.find((p: any) =>
      type === "source"
        ? p.sourceEnvironment === environment
        : p.targetEnvironment === environment
    );
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      >
        ...
        >
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (
                  e.target.value &&
                  sourceEnvironments.includes(e.target.value)
                ) {
          ...
          <div className="form-group">
            ...
            <div style={{ position: "relative" }}>
              ...
              <button
                type="button"
                aria-label="Toggle source token visibility"
                onClick={() => {
          ...
          <div style={{ display: "flex", gap: "0.5rem", marginTop: "1rem" }}>
            <button
              ...
              disabled={
                loading ||
                testResults.source?.loading ||
                !sourceUrl ||
                !sourceToken
              }
              style={{
                backgroundColor: testResults.source?.success
                  ? "#10b981"
                  : "#3b82f6",
                color: "white",
                padding: "0.5rem 1rem",
                ...
                borderRadius: "4px",
                cursor:
                  loading || testResults.source?.loading
                    ? "not-allowed"
                    : "pointer",
                opacity:
                  loading ||
            ...
            {(isLocal(sourceUrl)) && (
              ...
              disabled={
                loading || !sourceEnvironment || !sourceUrl || !sourceToken
              }
              style={{
                backgroundColor: "#6b7280",
                color: "white",
        ...
        >
          <h3 style={{ margin: "0 0 1rem 0", color: "#047857" }}>
            📥 Target Instance
          </h3>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (
                  e.target.value &&
                  targetEnvironments.includes(e.target.value)
                ) {
          ...
          <div className="form-group">
            ...
            <div style={{ position: "relative" }}>
              ...
              <button
                type="button"
                aria-label="Toggle target token visibility"
                onClick={() => {
                  const input = document.getElementById(
                    "targetToken"
                  ) as HTMLInputElement;
          ...
          <div style={{ display: "flex", gap: "0.5rem", marginTop: "1rem" }}>
            <button
              ...
              disabled={
                loading ||
                testResults.target?.loading ||
                !targetUrl ||
                !targetToken
              }
              style={{
                backgroundColor: testResults.target?.success
                  ? "#10b981"
                  : "#3b82f6",
                color: "white",
                padding: "0.5rem 1rem",
                ...
                borderRadius: "4px",
                cursor:
                  loading || testResults.target?.loading
                    ? "not-allowed"
                    : "pointer",
                opacity:
                  loading ||
            ...
            {isLocal(targetUrl) && (
              ...
              disabled={
                loading || !targetEnvironment || !targetUrl || !targetToken
              }
              style={{
                backgroundColor: "#6b7280",
                color: "white",
      ...
      <div style={{ textAlign: "center", marginBottom: "2rem" }}>
        <button
          type="submit"
          disabled={
            loading || !sourceUrl || !targetUrl || !sourceToken || !targetToken
          }
          style={{
